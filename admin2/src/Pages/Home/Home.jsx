        ...
        <div className="grid grid-cols-4 gap-4 mt-16">
          <div className="bg-white rounded-lg shadow-lg p-4">
            <div className=" flex items-center justify-between">
              <div className="rounded-full p-3 bg-black/80 mt-[-90px]">
                <RiSofaFill className="text-white text-5xl" />
              </div>
              <div>
                <div className="text-gray-500">Bookings</div>
                <div className="text-2xl font-bold text-gray-800">281</div>
              </div>
            </div>
            <span class="block border-b border-indigo-200 w-full h-[1px] mt-3 mb-3"></span>
            <div className="text-sm text-green-500">+55% than last week</div>
          </div>
          <div className="bg-white rounded-lg shadow-lg p-4">
            <div className=" flex items-center justify-between">
              <div className="rounded-full p-3 bg-black/80 mt-[-90px]">
